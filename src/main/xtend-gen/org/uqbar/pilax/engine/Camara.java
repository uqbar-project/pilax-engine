...
import org.uqbar.pilax.engine.DataMovimiento;
...
public class Camara {
  ...
  public void setX(final int x) {
    ...
    float _floatValue = Integer.valueOf(x).floatValue();
    Camara _self = PythonUtils.<Camara>self(this);
    Integer _y = _self.getY();
    float _floatValue_1 = _y.floatValue();
    Camara _self_1 = PythonUtils.<Camara>self(this);
    Integer _x = _self_1.getX();
    int _minus = (x - (_x).intValue());
    float _floatValue_2 = Integer.valueOf(_minus).floatValue();
    DataMovimiento _dataMovimiento = new DataMovimiento(Float.valueOf(_floatValue), Float.valueOf(_floatValue_1), Float.valueOf(_floatValue_2), Float.valueOf(0f));
    _mueveCamara.emitir(_dataMovimiento);
  ...
  public void setY(final int y) {
    ...
    Camara _self = PythonUtils.<Camara>self(this);
    Integer _x = _self.getX();
    float _floatValue = _x.floatValue();
    float _floatValue_1 = Integer.valueOf(y).floatValue();
    Camara _self_1 = PythonUtils.<Camara>self(this);
    Integer _y = _self_1.getY();
    int _minus = (y - (_y).intValue());
    float _floatValue_2 = Integer.valueOf(_minus).floatValue();
    DataMovimiento _dataMovimiento = new DataMovimiento(Float.valueOf(_floatValue), Float.valueOf(_floatValue_1), Float.valueOf(0f), Float.valueOf(_floatValue_2));
    _mueveCamara.emitir(_dataMovimiento);
    Pilas _instance_1 = Pilas.instance();
    Mundo _mundo = _instance_1.getMundo();
    Motor _motor = _mundo.getMotor();
